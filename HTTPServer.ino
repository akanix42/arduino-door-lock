...
#define WLAN_SSID       "SunnySideUp"   // cannot be longer than 32 characters!
#define WLAN_PASS       "g5gy##+fki+i"
...
Servo servo;  
int servoPosition = 0;    
int servoLockPosition = 180;
int servoUnlockPosition = 1;
int servoRestPosition = 90;

int unlockButtonPin = 6;
int lockButtonPin = 5;
int buttonState = 0;
...
void checkLockButtons(){
  buttonState = digitalRead(unlockButtonPin);
  if (buttonState == LOW) {
      unlock();
  }
...
void handleIncomingRequests(){
  Serial.println(F("Check for client"));
